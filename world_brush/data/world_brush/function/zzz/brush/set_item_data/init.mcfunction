item modify entity @s weapon.mainhand {function:"minecraft:set_custom_data",tag:{world_brush:{operation:null}}}
$item modify entity @s weapon.mainhand {function:"minecraft:set_custom_data",tag:{world_brush:{operation:$(operation)}}}

execute if data storage world_brush:temp all.operation{operation:select} run return run item modify entity @s weapon.mainhand {function:"minecraft:set_components",components:{"!minecraft:custom_name":{}}}
...
execute if data storage world_brush:temp all.operation{operation:save_structure} run return run item modify entity @s weapon.mainhand {function:"minecraft:set_components",components:{"minecraft:custom_name":"Place Structure Block"}}
