execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:type_specific/player":{input:{sprint:1b}}}} run return run dialog show @s world_brush:main
